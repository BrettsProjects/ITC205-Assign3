...
/**
 * STUB CLASS VERSION OF BOOK. For BookHelperTest.java and BookHelperTest.java
 * @author Brett Smith
 */
public class StubBook implements IBook {
     ...
     */
    public StubBook(String author, String title, String callNumber, int bookId)
            throws IllegalArgumentException
    {
